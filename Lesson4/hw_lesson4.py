...
print(list)  # вывод списка четных чисел от 100 до 1000
...
print(reduce(my_func, list))  # вывод произведения четных чисел от 100 до 1000
...
def gen1():
    ...
    for i in islice(count(a), 10):  # генератор 10 чисел начиная с указанного
        print(i)
...
def gen2():
    ...
    for el in islice(cycle(list), 7):  # завершение после 7 повторений
        print(el)
...
n = int(input("Ведите число для расчета факториала\n"))
for _ in fact_gen(n):
    print(_)
